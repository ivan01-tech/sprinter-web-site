      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-2xl px-6 md:px-12 py-12">
        ...
        >
          ...
          <div>
            <select
              {...register("subject")}
              className="w-full border border-gray-300 rounded-md px-4 py-3 text-gray-500 focus:outline-none focus:ring-2 focus:ring-red-400"
            >
          ...
          <div className="md:col-span-2 text-center">
            <button
              ...
              className={`bg-red-400 text-black font-semibold py-3 px-8 rounded-full transition duration-300 ${
