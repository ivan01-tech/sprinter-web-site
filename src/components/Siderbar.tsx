  ...
  return (
    <div className="fixed right-0 top-0 h-full w-96 bg-white text-black shadow-xl p-8 overflow-y-auto z-50">
      ...
      <div className="mt-12 flex justify-center">
        <button className="bg-yellow-400 w-40 h-40 rounded-full text-white font-bold text-center flex flex-col items-center justify-center text-lg shadow-lg hover:bg-red-50 transition-all">
          Demander un devis
        </button>
      </div>
    </div>
